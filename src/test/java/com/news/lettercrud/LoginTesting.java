...
import com.news.lettercrud.Services.auth.impl.LoginServiceImpl;
...
public class LoginTesting {
        ...
        private final Logger logger = LoggerFactory.getLogger(com.news.lettercrud.Services.auth.impl.LoginServiceImpl.class);
